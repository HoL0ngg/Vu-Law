...
practice area (description, "OUR SERVICES" list, CTA), then a closing statement.
...
Note on capitalisation: the user instructed that the word "Client" is always capitalised.
The Client's document writes "client" in lower case in these paragraphs; the strings below
carry the capitalised form that the site renders. This is a deliberate, user-directed
deviation from the source document, not a transcription error.

## 1. Page intro

```text
Integritas Vu Legal advises and represents businesses, investors and private Clients in transactions, disputes and significant legal matters. Each matter is approached with the Client's objectives, relevant risks and the practical viability of available options in mind.
...
| CTA | Destination |
|---|---|
| SPEAK WITH OUR LAWYERS | `/contact` |

## 2. Core practice areas (the index list)
...
Each is an in-page anchor to the matching block below.
...
| M&A & Investment | `#m-and-a-investment` |
